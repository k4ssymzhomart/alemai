...
1. **December 2025: the ФСМС scandal.** Government IT-audit found systemic fraud in billing: **3,640 services billed to 996 deceased patients** (including a 2025 appointment for a patient who died in 2023), **769,446 screenings not matching the patient's sex (~1.8 bn ₸)**, **68,717 cases of drug приписки on children**. On 18.12.2025 PM Bektenov ordered ФСМС transferred under **Ministry of Finance control**. Payment discipline in 2026 is the strictest in the system's history. Clinics that can't self-audit before billing will bleed money.
